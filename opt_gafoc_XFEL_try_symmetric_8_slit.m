...
R_g_tang=270+10*nnnn;%225           %tangential radius of grating new according to PRD !!!!!!
...
z3_t_offset=1.742-0.005*nnn+0.4;       %Grating to refocusing mirror distance 

slitpos=1.000+0.5+0.4;          %slit position !!!
sourcesize_x=1;
deltaU=6.1;
%deltaU=0;
