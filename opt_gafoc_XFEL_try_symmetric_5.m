...
%nowI try to get optimum design with respect to tolerances
...
R_g_sag=0.39;           %sagital radius of grating     !!!!!
%R_g_sag=0.47;
...
Theta_g_i=deg2rad(1.00+0.00);     %incidence angle new according to PRD        !!!!!!!
nnn=8;
R_m_tang=41.5-5.7-0.6*nnn;          %tangential radius of mirror M2 !!!
Theta_m_i=0.015;         %M2 incidence angle original!!!
%Theta_m_i=0.02;         

z3_t_offset=1.22;       %Grating to refocusing mirror distance original !!!
z3_t_offset=1.22+0.62-0.06-0.005*nnn+0.003;       %Grating to refocusing mirror distance 
