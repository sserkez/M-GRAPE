...
D0=500; %[l/mm]
D1=2.12; %[l/mm2]
D1=0.58+0.01*nnnn+0.00; %[l/mm2]1.41
D2=0.0015; %[l/mm3]
D2=0.001; %[l/mm3] %remove?
...
R_g_tang=160+10*nnnn;%225           %tangential radius of grating new according to PRD !!!!!!
R_g_sag=0.4;           %sagital radius of grating     !!!!!
R_g_sag=0.32;  
%R_g_sag=0.30; %sagital radius of grating     !!!!!
%R_g_sag=0.47;
...
Theta_g_i=deg2rad(1);     %incidence angle new according to PRD        !!!!!!!
nnn=-14;%3
%nnn=-20;%3
R_m_tang=31-0.6*nnn;          %tangential radius of mirror M2 !!!
Theta_m_i=0.015+0.00;         %M2 incidence angle original!!!
...
z3_t_offset=1.74-0.005*nnn+0.008;%+0.02;       %Grating to refocusing mirror distance 

slitpos=1.500+0.005;          %slit position !!!
sourcesize_x=1.0;
deltaU=6.1;
%  deltaU=0;
