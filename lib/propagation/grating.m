function[X_out]=grating(X_in,leng,xlamds,z1,z2,R_t,R_s,Theta_i,Theta_d,dTheta_d,D0,D1,D2,aberration)
...
dM=round(M*(1-gr_asym)/2);
P_in=sum(sum(abs(X_in(dM:M-dM,:)).^2));
%
