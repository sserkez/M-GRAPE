...
D0=800; %[l/mm]
D1=2.12; %[l/mm2]
D1=1.01+0.01*nnnn+0.00; %[l/mm2]1.41
D2=0.0015; %[l/mm3]
...
R_g_tang=220+10*nnnn;%225           %tangential radius of grating new according to PRD !!!!!!
...
Theta_m_i=0.015-0.002;         %M2 incidence angle original!!!
...
z3_t_offset=1.74-0.005*nnn+0.003;%+0.02;       %Grating to refocusing mirror distance 
