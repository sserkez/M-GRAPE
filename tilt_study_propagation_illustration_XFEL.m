...
nm_p='c:\-D-\Work\SASE3_SXRSS\700_u1_tdp.out';
nm_f=[nm_p,'.dfl'];
...
interpM=3;%4 2 8 3 6
interpL=3;%3 2 3 4 2 %4,3,2 (8,5,1.3) for 930eV LCLS run simulation
Npad=1; %2 2 1 2 1
...
% %R_g_tang=195;           %tangential radius of grating   
% R_g_tang=240;           %tangential radius of grating new according to PRD 
% R_g_sag=0.41;           %sagittal radius of grating   
% %Theta_g_i=1*0.01745;     %incidence angle      
% Theta_g_i=deg2rad(1.00);     %incidence angle new according to PRD   [rad]
% 
m2_length=0.025;
% R_m_tang=31.0;          %tangential radius of mirror M2 [m]
% Theta_m_i=0.015;         %M2 incidence angle original [rad]
% %Theta_m_i=0.02;         %M2 incidence angle original
% 
% z3_t_offset=1.74;       %Grating to refocusing mirror distance original
% %z3_t_offset=1.59;       %Grating to refocusing mirror distance 
% 
% slitpos=1.5;          %grating to slit distance
% 
