...
R_g_tang=160;           %tangential radius of grating new according to PRD !!!!!!
R_g_sag=0.25;           %sagital radius of grating     !!!!!
...
R_m_tang=27.2;          %tangential radius of mirror M2 !!!
Theta_m_i=0.015;         %M2 incidence angle original!!!
%Theta_m_i=0.02;         

z3_t_offset=1.22;       %Grating to refocusing mirror distance original !!!
z3_t_offset=1.22;       %Grating to refocusing mirror distance !!!

slitpos=1.007;          %slit position !!!
