...
%[XX,N]=fieldimport_all('D:\Work\!PROJECTS\ocelot_test\test_phase_2\run_0\run.0.s2.gout.dfl',d(Di).inp.ncar,1); %REMOVE!!!!!!!!!!!!!!!!!!!!!!
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
...
fieldplot3d_a(1114,XX,d(Di).inp.leng,d(Di).inp.leng,1,dflSscale,[nm_p{Di},'.dfl'],1);
%fieldplot3d(1113,XX,d(Di).inp.leng,1,dflSscale,[nm_p{Di},'.dfl'],1);
[X2,dflLamdscale]=dfl_time2freq(XX,dflSscale,d(Di).inp.xlamds);
fieldplot3d_a(1115,X2,d(Di).inp.leng,d(Di).inp.leng,0,dflLamdscale,[nm_p{Di},'_freq.dfl'],1);
%%
